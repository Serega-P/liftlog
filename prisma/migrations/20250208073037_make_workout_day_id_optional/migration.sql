...
CREATE TABLE "trisets" (
    ...
    CONSTRAINT "trisets_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "sub_sets" (
    "id" SERIAL NOT NULL,
    "trisetId" INTEGER NOT NULL,
    "weight" DOUBLE PRECISION,
    "reps" INTEGER,
...
-- AddForeignKey
ALTER TABLE "trisets" ADD CONSTRAINT "trisets_setGroupId_fkey" FOREIGN KEY ("setGroupId") REFERENCES "set_group"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "sub_sets" ADD CONSTRAINT "sub_sets_trisetId_fkey" FOREIGN KEY ("trisetId") REFERENCES "trisets"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
